...
|-------|-------|-----------------|
| **Organization/User** | Your GitHub org (e.g., `ThosePeople`) | ❌ lowercase<br />❌ different org name |
| **Repository** | Repository name (e.g., `Peeps-Design-System`) | ❌ lowercase<br />❌ wrong repo |
...
```json
{
  "changelog": ["@changesets/changelog-github", {
    "repo": "ThosePeople/Peeps-Design-System"
  }],
  "access": "public",
  "baseBranch": "main"
}
